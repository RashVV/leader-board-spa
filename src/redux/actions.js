import { EDITED_USER_SCORE, ADDED_NEW_USER, FETCH_USERS, FETCH_FAILED, FETCH_NEW_USERS, PAGINATE_USERS } from './actionType';
...
export const addNewUser = ({user}) =>  ({
  ...
  export const paginationUsers = (currentArr) => ({
    type: PAGINATE_USERS,
    payload: currentArr
  })
